...
public class DbLoginModule implements LoginModule
{
	...
	public boolean commit() throws LoginException
	{
		...
		// set credential
		DbUsernameCredential cred = new DbUsernameCredential( userId, username );
	...
	static private Set lookupGroups(String username) throws LoginException
	{
	...
	private static Principal
			resolvePrincipal(String groupName, String className)
	{
		Exception e = null;
		try
		{
			...
			if ( Principal.class.isAssignableFrom( clazz ) )
			{
				...
				return (Principal) c.newInstance( new Object[] { groupName } );
			}
		}
		...
		LOGGER.logp( Level.WARNING, CLASS_NAME, "resolvePrincipal()",
